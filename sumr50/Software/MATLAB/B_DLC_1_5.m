% function [output] = B_DLC_1_5(Turbine,Name_Model,Name_Control)
...
% Parameters.Turbine.String = Turbine;
...
ECDCases = {'EWSH+6.0','EWSH+11.0','EWSH-6.0','EWSH-11.0','EWSV+6.0','EWSV-6.0'};
MeanWindSpeeds = 10;
...
%     ED.RotSpeed  = Parameters.Turbine.IC.Wr;
    ...
    disp(['Simulating Turbine w/ ',IW.Filename]);
