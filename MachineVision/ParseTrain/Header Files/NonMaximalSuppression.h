...
{
public:
    void NMS(std::vector<std::string> &label, std::vector<Rect> &rects, std::vector<Rect*> &bboxloc, std::vector<std::string>& bboxlabel_afteriou, std::vector<cv::Rect*>& bboxloc_afteriou, std::vector<std::vector<int>> &bboxnum)
	{
        cv::Rect bbox_tmpa;
        cv::Rect bbox_tmpb;
