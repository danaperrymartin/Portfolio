...
public:
    ...
    void Watershed(Mat &im, std::vector<Rect>& rects)
    {
        Mat graymat;
        Mat opening;
        Mat sure_bg(256, 512, CV_32F);
        Mat sure_fg(256,512, CV_32F);
        Mat dist_transform;
        Mat unknown(256, 512, CV_32F);
        Mat mask;
        ...
        GaussianBlur(graymat, graymat, Size(5,5),100);
