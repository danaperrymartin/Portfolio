...
class Pix2PixModel:
    ...
    def pix2pixfromscratch(self):
        ...
        #                   use_bias=False, dilation_rate=(1,1), name='b1_conv2dTrans_1', kernel_initializer=initializer)(input)
        ...
        b1_conv2d_3    = layers.Conv2D(filters=16, kernel_size=(1, 1), strides=(1, 1), padding='same',
                         use_bias=False, dilation_rate=1, groups=1, name='b1_cnv2d_3', kernel_initializer=initializer)(b1_conv2d_2)
        ...
        # Block 2
        b2_pad_1    = layers.ZeroPadding2D(padding=(0, 0), name='b2_pad_1', data_format=None)(b1_norm_1)
        ...
        b2_conv2d_2 = layers.Conv2D(filters=24, kernel_size=(1, 1), strides=(1, 1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b2_cnv2d_2', kernel_initializer=initializer)(b2_conv2d_1)
        # Block 3
        ...
        b3_conv2d_2 = layers.Conv2D(filters=144, kernel_size=(3,3), strides=(1, 1), padding='same',
                         use_bias=False, dilation_rate=1, groups=1, name='b3_cnv2d_2', kernel_initializer=initializer)(b3_norm_1)
        ...
        b3_conv2d_3 = layers.Conv2D(filters=24, kernel_size=(1,1), strides=(1, 1), padding='same',
                         use_bias=False, dilation_rate=1, groups=1, name='b3_cnv2d_3', kernel_initializer=initializer)(b3_conv2d_2)
        ...
        # Block 4
        b4_pad_1    = layers.ZeroPadding2D(padding=(0, 0), name='b4_pad_1', data_format=None)(b23_conv2d_1)
        ...
        b4_conv2d_2 = layers.Conv2D(filters=32, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b4_conv2d_2', kernel_initializer=initializer)(b4_conv2d_1)
        # Block 5
        ...
        b5_conv2d_2 = layers.Conv2D(filters=192, kernel_size=(3,3), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b5_conv2d_2', kernel_initializer=initializer)(b5_norm_1)
        ...
        b5_conv2d_3 = layers.Conv2D(filters=32, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b5_conv2d_3', kernel_initializer=initializer)(b5_conv2d_2)
        ...
        b6_conv2d_2 = layers.Conv2D(filters=192, kernel_size=(3,3), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b6_conv2d_2', kernel_initializer=initializer)(b6_conv2d_1)
        ...
        b6_conv2d_3 = layers.Conv2D(filters=32, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b6_conv2d_3', kernel_initializer=initializer)(b6_conv2d_2)
        # Add blocks 5 & 6
        ...
        # Block 7
        b7_pad_1    = layers.ZeroPadding2D(padding=(0, 0), name='b7_pad_1', data_format=None)(b56_conv2d_1)
        ...
        b7_conv2d_2 = layers.Conv2D(filters=64, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=1, groups=1, name='b7_conv2d_2', kernel_initializer=initializer)(b7_conv2d_1)
        ...
        b8_conv2d_2 = layers.Conv2D(filters=384, kernel_size=(3,3), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=1, groups=1, name='b8_conv2d_2', kernel_initializer=initializer)(b8_norm_1)
        ...
        b8_conv2d_3 = layers.Conv2D(filters=64, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=1, groups=1, name='b8_conv2d_3', kernel_initializer=initializer)(b8_conv2d_2)
        ...
        b9_conv2d_2 = layers.Conv2D(filters=384, kernel_size=(3,3), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=1, groups=1, name='b9_conv2d_2', kernel_initializer=initializer)(b9_conv2d_1)
        ...
        b9_conv2d_3 = layers.Conv2D(filters=64, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=1, groups=1, name='b9_conv2d_3', kernel_initializer=initializer)(b9_conv2d_2)
        ...
        b10_conv2d_2 = layers.Conv2D(filters=384, kernel_size=(3,3), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=1, groups=1, name='b10_conv2d_2', kernel_initializer=initializer)(b10_conv2d_1)
        ...
        b10_conv2d_3 = layers.Conv2D(filters=64, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=1, groups=1, name='b10_conv2d_3', kernel_initializer=initializer)(b10_conv2d_2)
        ...
        b11_conv2d_2 = layers.Conv2D(filters=384, kernel_size=(3,3), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=1, groups=1, name='b11_conv2d_2', kernel_initializer=initializer)(b11_conv2d_1)
        ...
        b11_conv2d_3 = layers.Conv2D(filters=96, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b11_conv2d_3', kernel_initializer=initializer)(b11_conv2d_2)
        ...
        b12_conv2d_2 = layers.Conv2D(filters=576, kernel_size=(3,3), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b12_conv2d_2', kernel_initializer=initializer)(b12_norm_1)
        ...
        b12_conv2d_3 = layers.Conv2D(filters=96, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b12_conv2d_3', kernel_initializer=initializer)(b12_conv2d_2)
        ...
        b13_conv2d_2 = layers.Conv2D(filters=576, kernel_size=(3,3), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b13_conv2d_2', kernel_initializer=initializer)(b13_conv2d_1)
        ...
        b13_conv2d_3 = layers.Conv2D(filters=96, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b13_conv2d_3', kernel_initializer=initializer)(b13_conv2d_2)
        ...
        # Block 14
        b14_pad_1    = layers.ZeroPadding2D(padding=(0, 0), name='b14_pad_1', data_format=None)(b1213_conv2d_1)
        ...
        b14_conv2d_2 = layers.Conv2D(filters=160, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b14_conv2d_2', kernel_initializer=initializer)(b14_conv2d_1)
        ...
        b15_conv2d_2 = layers.Conv2D(filters=96, kernel_size=(3,3), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b15_conv2d_2', kernel_initializer=initializer)(b15_norm_1)
        ...
        b15_conv2d_3 = layers.Conv2D(filters=160, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b15_conv2d_3', kernel_initializer=initializer)(b15_conv2d_2)
        ...
        b16_conv2d_2 = layers.Conv2D(filters=96, kernel_size=(3,3), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b16_conv2d_2', kernel_initializer=initializer)(b16_conv2d_1)
        ...
        b16_conv2d_3 = layers.Conv2D(filters=160, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b16_conv2d_3', kernel_initializer=initializer)(b16_conv2d_2)
        ...
        b17_conv2d_2 = layers.Conv2D(filters=96, kernel_size=(3,3), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b17_conv2d_2', kernel_initializer=initializer)(b17_conv2d_1)
        ...
        b17_conv2d_3 = layers.Conv2D(filters=1, kernel_size=(1,1), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), groups=1, name='b17_conv2d_3', kernel_initializer=initializer)(b17_conv2d_2)
        ...
        # Block 18
        b18_concat_1 = layers.Concatenate(axis=0)([b1213_conv2d_1, b17_relu_1])
        
        # b18_add_1 = layers.Add()([b1213_conv2d_1, b17_relu_1])
        ...
        # b19_concat_1 = layers.Concatenate(axis=0)([b1_norm_1, b18_relu_1])
        
        b19_add_1 = layers.Add()([b1_norm_1, b18_relu_1])
        
        b19_conv2dTrans_1 = layers.Conv2DTranspose(filters=1, kernel_size=(3,3), strides=(1,1), padding='same',
                         use_bias=False, dilation_rate=(1,1), name='b19_conv2dTrans_1', kernel_initializer=initializer)(b19_add_1)
        ...
        b19_add_2 = layers.Add()([b19_conv2dTrans_1, b19_upsample_1])
                
        output = layers.Dense(self.output_shape, name='model_output', activation='sigmoid',kernel_initializer=initializer)(b19_add_2)
