...
#define STRING_CONFIG_H_AUTHOR "Dana Martin, CR-10 V3)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  56.61
    #define DEFAULT_Ki  11.15
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // CR-10 V3 24V 240W
  #define DEFAULT_bedKp 82.62
  #define DEFAULT_bedKi 16.01
  #define DEFAULT_bedKd 284.28
 ...
 * -   (configuration_adv.h) can be used for setting the Z offset.
 *
